# Stewardship-OS
An autonomous, decentralized energy OS. Building the resilient mesh for the era of energy Stewardship OS
...
Getting Started
Stewardship OS is built as a custom integration for Home Assistant.
Prerequisites
...
This project is licensed under AGPLv3. We welcome code contributions, logic improvements, and hardware integrations.
 Before contributing: Please review the CONSTITUTION.md to ensure your changes align with the project's core principles.
